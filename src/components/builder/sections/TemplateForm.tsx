...
const TEMPLATES: Array<{ id: ResumeData['template']; label: string; description: string }> = [
  { id: 'modern', label: 'Modern', description: 'Bold gradient header, great for tech & creative roles' },
  { id: 'classic', label: 'Classic', description: 'Centered, traditional layout — safe for any industry' },
  { id: 'minimal', label: 'Minimal', description: 'Clean and airy, lets your content do the talking' },
  { id: 'corporate', label: 'Corporate', description: 'Sidebar layout, ideal for senior & executive roles' },
];
          ...
          return (
            ...
            >
              <div className="aspect-[3/4] bg-muted/40 relative">
                <div className="absolute inset-2 rounded-lg border border-border shadow-sm overflow-hidden bg-white">
                  <ResumeThumbnail resume={{ ...resume, template: tpl.id }} />
                </div>
                {isActive && (
